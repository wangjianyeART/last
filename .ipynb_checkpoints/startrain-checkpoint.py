...
from code.util import get_chunks, get_label_lists, F1, LSTMCRFLearningRate
from code.model_utils.config import config
from code.changedata import get_data_set
from code.ib import ImdbParser
...
from code.model_utils.LSTM_CRF import Lstm_CRF
def train_lstm_crf():
    """ train lstm_crf """
    print('\ntrain.py config: \n', config)
